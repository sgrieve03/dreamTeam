 ...
 *
 */
public class CommunicationAdapter extends StaffManagementSystem {
	...
	/**
	 * Method to alert the appropriate staff via sms or email
	 * 
	 * @param alert
	 *            - Alert
	 * @throws Exception
	 */	
	void alertStaff(Alert alert) throws Exception{
